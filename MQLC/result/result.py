...
with open(file_path1, 'w', newline='') as csvfile:
    ...
    for i in range(10):
        episodes = (i+1)*1000
        # /home/qiao/he/MQLC/rl-agents/scripts/out/HighwayEnv/DQNAgent/MQLC test_0109_
        # filename = '/home/qiao/he/MQLC/rl-agents/scripts/out/HighwayEnv/DQNAgent/MQLC_0108_episode_test/MQLC test_0109_' + str(episodes) + '/openaigym.episode_batch.' + str(i+1) + '.15401.stats.json'
        # filename = '/home/qiao/he/MQLC/rl-agents/scripts/out/HighwayEnv/DQNAgent/MQLC_0109_attack_train_attack_test/MQLC_attack_test_0110_' + str(episodes) + '/openaigym.episode_batch.' + str(i+1) + '.16526.stats.json'
        # filename = '/home/qiao/he/MQLC/rl-agents/scripts/out/HighwayEnv/DQNAgent/MQLC test_0109_1000/openaigym.episode_batch.1.15401.stats.json'
        filename = '/home/qiao/he/MQLC/rl-agents/scripts/out/HighwayEnv/DQNAgent/MQLC_0420_attack_test_25_0507_' + str(episodes) + '/openaigym.episode_batch.' + str(i+1) + '.22203.stats.json'
