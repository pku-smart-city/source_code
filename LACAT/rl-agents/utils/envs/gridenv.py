...
class GridEnv(Env):
    ...
    config = {"use_diagonals": False, "stochasticity": 0}
    ...
    def reward(self):
        return np.clip(
            1
            - 1
            / self.REWARD_RADIUS**2
            * (
                (self.REWARD_CENTER[0] - self.x[0]) ** 2
...
register(id='gridenv-v0', entry_point='autils.envs:GridEnv')

register(id='line_env-v0', entry_point='autils.envs:LineEnv', max_episode_steps=10)
