...
class AbstractEnv(gym.Env):
    ...
    def __init__(self, config: dict = None, render_mode: str | None = None) -> None:
        ...
        self.llm_observation_type = None
        self.llm_action_type = None
        self.llm_observation_space = None
        self.llm_action_space = None
        ##############新增###############
    ...
    def define_spaces(self) -> None:
        ...
        ##############新增###############
        self.llm_observation_type = observation_factory(self, self.config["llm_observation"])
        self.llm_action_type = action_factory(self, self.config["llm_action"])
        self.llm_observation_space = self.llm_observation_type.space()
        self.llm_action_space = self.llm_action_type.space()
        ##############新增###############
